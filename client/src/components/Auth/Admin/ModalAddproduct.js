                                ...
                                <div className={handleChangePage ? 'modal-add-product-images-visible' : 'modal-add-product-images-none'}>
                                    ...
                                    <div className="form-group col" >
                                        <div className='d-flex justify-content-between'>
                                            ...
                                            {infosProduct !== null && (infosProduct.pictures[0] !== undefined ? <img style={{height:'50px'}} src={picture1 != undefined ? picture1 : 'http://ec2-13-51-198-6.eu-north-1.compute.amazonaws.com/uploads/imagesUsersProfil/' + infosProduct.pictures[0].filename}></img> : <img style={{height:'50px'}} src={picture1}></img>)} 
                                        </div>
                                    ...
                                    <div className="form-group col" >
                                        <div className='d-flex justify-content-between'>
                                            ...
                                            {infosProduct !== null && (infosProduct.pictures[1] !== undefined ? <img style={{height:'50px'}} src={picture2 != undefined ? picture2 : 'http://ec2-13-51-198-6.eu-north-1.compute.amazonaws.com/uploads/imagesUsersProfil/' + infosProduct.pictures[1].filename}></img> : <img style={{height:'50px'}} src={picture2}></img>)} 
                                    ...
                                    <div className="form-group col" >
                                        <div className='d-flex justify-content-between'>
                                            ...
                                            {infosProduct !== null && (infosProduct.pictures[2] !== undefined ? <img style={{height:'50px'}} src={picture3 != undefined ? picture3 : 'http://ec2-13-51-198-6.eu-north-1.compute.amazonaws.com/uploads/imagesUsersProfil/' + infosProduct.pictures[2].filename}></img> : <img style={{height:'50px'}} src={picture3}></img>)} 
                                    ...
                                    <div className="form-group col" >
                                        <div className='d-flex justify-content-between'>
                                            ...
                                            {infosProduct !== null && (infosProduct.pictures[3] !== undefined ? <img style={{height:'50px'}} src={picture4 != undefined ? picture4 : 'http://ec2-13-51-198-6.eu-north-1.compute.amazonaws.com/uploads/imagesUsersProfil/' + infosProduct.pictures[3].filename}></img> : <img style={{height:'50px'}} src={picture4}></img>)} 
                                        </div>
                                        <small className="text-danger">
